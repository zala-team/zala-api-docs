...
|-------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| id                | The universal unique identifier for the Price (UUID)                                                                                                                                                  |
| serviceId         | The UUID of the service which this price belongs to                                                                                                                                                   |
| price             | Price in Money format                                                                                                                                                                                 |
| downPaymentAmount            | List of the url-friendly strings generated from the Product's names, in every language supported by the store                                                                                         |
